...
using Travels.DataAccess.Repository.Package.Repository;
using Travels.DataAccess.Repository.SupplyPartner.Interface;
using Travels.DataAccess.Repository.SupplyPartner.Repository;
using Travels.DataAccess.Repository.TailorTrip.Interface;
using Travels.DataAccess.Repository.TailorTrip.Repository;
